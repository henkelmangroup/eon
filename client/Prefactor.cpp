...
VectorXi Prefactor::movedAtoms(Parameters* parameters,
                               Matter *min1, Matter *saddle, Matter *min2)
{
...
VectorXi Prefactor::movedAtomsPct(Parameters* parameters,
                                  Matter *min1, Matter *saddle, Matter *min2) {
    long nAtoms = saddle->numberOfAtoms();
